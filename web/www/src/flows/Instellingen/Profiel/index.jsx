  ...
  return useObserver(() => (
   ...
   <div className={`${styles.profiel_pos} ${styles.beweging_wrapper}`}>
      ...
      <div className={styles.bewegen_position}>
            <input type="radio" checked={dataStore.bewegen === 'kroes'} onChange={e => dataStore.setBewegen('kroes')} name='kroes' id={'kroes'}></input>
            <label className={styles.thema_radio} htmlFor={'kroes'}>
                  <div className={`${styles.bewegen_text} ${styles.box}`}>
                        ...
                        <input type="radio" checked={dataStore.sbewegen === 'skate'} onChange={e => dataStore.setBewegen('skate')} name='skate' id={'skate'}></input>
                        <label className={styles.thema_radio} htmlFor={'skate'}>
                              <div className={`${styles.bewegen_text} ${styles.box}`}>
                                    ...
                                    <input type="radio" checked={dataStore.bewegen === 'fly'} onChange={e => dataStore.setBewegen('fly')} name='fly' id={'fly'}></input>
