...
const Keuze = () => {
  ...
  const handleStart = () => {
    uiStore.setCurrentReis(bestemming);
  }
  ...
  return (
    ...
    <section className={styles.section}>
        ...
        <p className={styles.uitleg}>Klaar om <span className={styles.uitleg_nadruk}>{bestemming.name}</span> te ontdekken?</p>
    </div>
    ...
    <section className={styles.section}>
        ...
        <p className={styles.uitleg}>Het ziet er naar uit dat je momenteel al in <span className={styles.uitleg_nadruk}>{uiStore.currentReis.name}</span> zit.</p>
